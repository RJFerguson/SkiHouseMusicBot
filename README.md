...
- Navigate to `test-cool-bot` folder
- Select `test-cool-bot.bot` file
...
msbot clone services --name "test-cool-bot" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
